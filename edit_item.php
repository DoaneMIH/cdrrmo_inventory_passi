        ...
        <div class="form-container">
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <textarea id="item_description" name="item_description" rows="3" required><?php echo htmlspecialchars($item['item_description']); ?></textarea>
                </div>
                
                <div class="form-row">
                    <div class="form-group">
                        <label for="items_received">Items Received *</label>
                        <input type="number" id="items_received" name="items_received" value="<?php echo $item['items_received']; ?>" min="0" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="items_distributed">Items Distributed</label>
                        <input type="number" id="items_distributed" name="items_distributed" value="<?php echo $item['items_distributed']; ?>" min="0">
                    </div>
